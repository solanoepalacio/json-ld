<div>
    ...
    <ul>
        ...
        <li><a href="/pages/static-src.php">Load json-ld using script element internal request machinery</a></li>
        <li><a href="/pages/static-src-transcript.php">Load json-ld & transcript using internal request machinery</a></li>

        <li><a href="/pages/content-loaded-src.php">Load json-ld adding a script element after dom content is loaded</a></li>
